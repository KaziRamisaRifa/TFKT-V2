...
config={
    ...
    'Batch':1,  # Batch size for the experiment
    ...
    'model':'EffSwinKAT', # Model name. Based on this parameter model will be generated from get_model.py
    'imgnet_pretrained':True,   #True: imagenet-pretrained model, False: Random initialization
    'xrv_pretrained':False,
    ...
    'kfold':1,  # Number of folds for cross-validation, 1 means hold-out test set
    ...
    'current_label':'stdev', # This will alter in each fold first std and then label
    ...
    'kadid_pretraining':False,
    'mayoct_pretraining':False,# If true, regression based pretraining
    'mayoct_classification_pretraining':False, # if true pretrain on mayoct data on classification
    'mayoct_path':'../mayoct_full_reference_preprocessed/train/',
    'experiment_name': "TFKTV2_inference" # String value as an experiment name.
}
